...
## Input:
* Preprocessed EEG signals from 4 channels: Fp1, Fp2, P3, P4
...
## Results:
### Table 1: Overall Performance (Mean Squared Error)
...
![alt text](plot_1_overall_english-1.png)


### Table 3: Performance by Patient Group (Mean Squared Error)
...
![alt text](plot_3_groups_english-1.png)

### Table 2: Performance by Electrode (Mean Squared Error)
...
![alt text](plot_2_electrodes_english-1.png)